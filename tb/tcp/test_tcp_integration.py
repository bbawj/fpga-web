...
from tcp.utils import TCPIntegrated, TCP_client_sim, PacketGen, PayloadLossyClient, TCP_rst_client, SynAckLossyClient
...
async def tcp_lossy_synack(dut):
    ...
    gen = PacketGen(client_ip, client_port)
    tcp = TCPIntegrated(tb, True, dst_mac, src_mac)
    cocotb.start_soon(cocotb.task.bridge(SynAckLossyClient)(
        tcp, client_ref, False, server_ip, server_port, client_ip, client_port, external_fd={"tcp": gen}))
    await Timer(22000, "ns")
    assert tcp.recv_count == 2
    client_ref[0].forcestop(wait=False)
    await Timer(5000, "ns")
...
def check_check(dut):
    b = """b025aa3306fe
"""
